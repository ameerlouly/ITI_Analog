...
N 240 -600 240 -560 {lab=AVDD}
N 50 -600 50 -560 {lab=AVDD}
N 50 -600 240 -600 {lab=AVDD}
N 50 -530 80 -530 {lab=AVDD}
N 80 -600 80 -530 {lab=AVDD}
N 240 -530 270 -530 {lab=AVDD}
N 270 -600 270 -530 {lab=AVDD}
N 240 -600 270 -600 {lab=AVDD}
N 240 -500 240 -440 {lab=#net6}
N 240 -410 270 -410 {lab=AVDD}
N 270 -530 270 -410 {lab=AVDD}
N 50 -500 50 -440 {lab=#net7}
N 50 -410 80 -410 {lab=AVDD}
N 80 -530 80 -410 {lab=AVDD}
N 50 -380 50 -150 {lab=VCASCN}
N 10 -180 10 -120 {lab=VCASCN}
N 10 -180 50 -180 {lab=VCASCN}
N 50 -90 50 70 {lab=AGND}
N 50 70 50 80 {lab=AGND}
N 50 80 240 80 {lab=AGND}
N 240 30 240 80 {lab=AGND}
N 220 0 240 0 {lab=AGND}
N 220 0 220 80 {lab=AGND}
N 50 -120 80 -120 {lab=AGND}
N 90 -120 90 80 {lab=AGND}
N 80 -120 90 -120 {lab=AGND}
N 220 -120 240 -120 {lab=AGND}
N 220 -120 220 0 {lab=AGND}
N 240 -390 240 -150 {lab=VCASCP}
N 280 0 380 0 {lab=VCASCP}
N 330 -190 330 0 {lab=VCASCP}
N 240 -190 330 -190 {lab=VCASCP}
N 280 -120 370 -120 {lab=VCASCN}
N -50 -530 10 -530 {lab=VB1}
N -40 -410 10 -410 {lab=IBn}
N 160 -410 200 -410 {lab=IBn}
N 160 -530 200 -530 {lab=VB1}
N -50 -410 -40 -410 {lab=IBn}
N 240 -90 240 -30 {lab=#net8}
...
C {devices/lab_pin.sym} 370 -120 2 0 {name=p3 sig_type=std_logic lab=VCASCN}
C {devices/lab_pin.sym} 380 0 2 0 {name=p10 sig_type=std_logic lab=VCASCP}
...
C {symbols/pmos_3p3.sym} 220 -530 0 0 {name=M16
L=1u
W=9.75u
nf=1
m=1
...
C {symbols/nmos_3p3.sym} 260 0 0 1 {name=M17
L=1u
W=7u
nf=1
m=1
...
C {symbols/pmos_3p3.sym} 220 -410 0 0 {name=M18
L=1u
W=20u
nf=1
m=1
...
C {symbols/nmos_3p3.sym} 260 -120 0 1 {name=M19
L=500n
W=500n
nf=1
m=1
...
C {symbols/pmos_3p3.sym} 30 -530 0 0 {name=M20
L=1u
W=9.75u
nf=1
m=1
...
C {symbols/pmos_3p3.sym} 30 -410 0 0 {name=M21
L=1u
W=20u
nf=1
m=1
...
C {symbols/nmos_3p3.sym} 30 -120 0 0 {name=M22
L=500n
W=500n
nf=1
m=1
...
C {devices/lab_pin.sym} 150 80 3 0 {name=p2 sig_type=std_logic lab=AGND}
C {devices/lab_pin.sym} 160 -600 1 0 {name=p4 sig_type=std_logic lab=AVDD}
C {devices/lab_pin.sym} 160 -410 1 0 {name=p11 sig_type=std_logic lab=IBn}
C {devices/lab_pin.sym} -50 -410 1 0 {name=p12 sig_type=std_logic lab=IBn}
C {devices/lab_pin.sym} 160 -530 1 0 {name=p13 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} -50 -530 1 0 {name=p14 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} 10 -180 1 0 {name=p15 sig_type=std_logic lab=VCASCN}
