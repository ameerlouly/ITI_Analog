...
C {balun.sym} 260 10 0 0 {name=balun2}
...
C {devices/vsource.sym} -340 80 0 0 {name=VICM value="AC 0" savecurrent=false}
C {devices/gnd.sym} -340 110 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} -400 20 0 0 {name=VID value="0 AC 1" savecurrent=false}
