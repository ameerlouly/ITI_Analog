...
sim_type=constants
autoload=1}
B 2 1520 -200 2320 200 {flags=graph
y1=-1.4e-08
y2=59
ypos1=0
ypos2=2
...
N 310 190 310 200 {lab=GND}
N 310 180 310 190 {lab=GND}
N 550 40 550 70 {lab=VOUT}
C {Lab09.sym} 330 40 0 0 {name=X1}
...
C {devices/isource.sym} 310 150 0 0 {name=I0 value=10u}
C {devices/vdd.sym} 330 -40 0 0 {name=l5 lab=VDD}
C {devices/vsource.sym} 0 120 0 0 {name=VICM value="0.6 AC 0" savecurrent=false}
...
C {devices/gnd.sym} 310 200 0 0 {name=l4 lab=GND}
